      ...
      <div className='contact__container container grid'>
        <div className='contact__data'>
          ...
          <p className='contact__description'>
            Feel free to get in touch with me. I am always open to discussing new projects, creative ideas or opportunities to be part of your versions.
          </p>
        ...
        <form className='contact__form'>
          <div className='form__input-group'>
            ...
            <div className='form__input-div'>
              <input className='form__control' type='email' placeholder='Your Email' />
            </div>

            <div className='form__input-div'>
              <input className='form__control' type='text' placeholder='Your Subject' />
            </div>
          </div>
